...
export default function BlogForm({ initialData = {}, onSubmit }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-[#000000]">
      {/* Page header */}
      <div className="max-w-7xl pt-20 mx-auto md:px-0 px-4  pb-6">
        <div className="flex items-end justify-between gap-3">
          <div>
            <p className="text-xs tracking-wider uppercase text-white">Editor</p>
            <h1 className="text-3xl text-white md:text-4xl font-semibold tracking-tight">Blog Editor</h1>
